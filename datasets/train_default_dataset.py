...
TrainDefaultDataset:
    ...
    - Is a deafult dataset to charge the images and labels and use them in the training process.

    - You can transform the images and labels with the transform parameter.

"""

class TrainDefaultDataset(Dataset):
